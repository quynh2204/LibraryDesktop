    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "J.K. Rowling", 1, "Assets/1.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Câu chuyện về cậu bé phù thủy Harry Potter và cuộc phiêu lưu đầu tiên tại trường Hogwarts. Khám phá thế giới phép thuật đầy kỳ diệu và những người bạn đồng hành.", 0, 2, "Harry Potter và Hòn đá Phù thủy", 0, 70 },
                    { 2, "Nguyễn Nhật Ánh", 2, "Assets/2ef1ef06a27bf5cd68fea90a24cc96dd.jpg", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Tác phẩm kể về tuổi thơ của những đứa trẻ miền quê, với những kỷ niệm đẹp về tình anh em, tình làng nghĩa xóm và những bài học cuộc sống quý giá.", 0, 2, "Tôi thấy hoa vàng trên cỏ xanh", 0, 50 },
                    ...
                    { 4, "Robert Kiyosaki", 3, "Assets/5cb878e981ec841cf8963c2dbfc837c3.jpg", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Cuốn sách dạy về tư duy tài chính và cách quản lý tiền bạc hiệu quả. Những bài học quý giá về đầu tư và xây dựng tài sản.", 50, 1, "Dạy con làm giàu", 0, 30 },
                    { 5, "Ngô Sĩ Liên", 5, "Assets/65b07f0ccb5631d4025d509c0c14e62d.jpg", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Tác phẩm sử học quan trọng ghi chép lịch sử Việt Nam từ thời cổ đại đến thế kỷ XV. Nguồn tài liệu quý giá về văn hóa và lịch sử dân tộc.", 0, 2, "Lịch sử Việt Nam: Đại Việt sử ký toàn thư", 0, 35 },
                    { 6, "Paulo Coelho", 6, "Assets/6a81c3d24a73711e02ba8593c067bccf.jpg", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Câu chuyện về chàng chăn cừu Santiago và cuộc hành trình tìm kiếm kho báu. Một tác phẩm triết lý sâu sắc về ước mơ và ý nghĩa cuộc sống.", 50, 1, "Nhà giả kim", 0, 40 },
                    { 7, "Dale Carnegie", 7, "Assets/9a321b2c38deed11aa8fb0e879cc6610.jpg", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Cuốn sách kinh điển về nghệ thuật giao tiếp và ứng xử. Hướng dẫn cách xây dựng mối quan hệ tốt và thành công trong cuộc sống.", 50, 1, "Đắc nhân tâm", 0, 45 }
                });
